...
$sql = "SELECT  i.quantity, sp.product_Name  FROM stk_inventory i INNER JOIN stk_products sp ON i.productId = sp.productId  WHERE inventory_id=$InventoryId";
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
            <li><a class="dropdown-item" href="./home.php">Add to Inventory</a></li>
