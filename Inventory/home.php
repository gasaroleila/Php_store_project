...
<div class="main">
  ...
  <div class="container-fluid">
    ...
    <div class="left">
        ...
        <form action="AddToInve.php" method="POST">
    ...
    <?php 
    $sql = "SELECT  * FROM stk_products where Status='Active'";
    ...
    if($query) {
      ...
      <input type="submit" name="Send" value="Add To Inventory">
      </form>
        </div>
    </div>
