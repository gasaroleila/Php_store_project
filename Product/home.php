...
<?php include '../utils/db.php'?>
  ...
  <div class="container-fluid">
      ...
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown">
          ...
          <?php if($_SESSION['role'] == 'Manager') {?>
            <li><a class="dropdown-item" href="./home.php">Create a Product</a></li>
              <?php }?>
    ...
    <div class="left">
        ...
        <input type="text" name="prodName" id="pname" required>
      </div>
  
      <div class="row">
        <label for="brand">Brand</label>
        <input type="text" name="brand" id="brand" requied>
      </div>

      <div class="row">
        <label for="suphone">supplier_phone</label>
        <input type="tel" name="supplier-phone" id="suphone" required min=0>
       </div>
