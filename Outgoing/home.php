...
<?php include '../utils/db.php'?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
            <li><a class="dropdown-item" href="#">Register Outgoing</a></li>
    ...
    <div class="left">
        ...
        <form action="AddTout.php" method="POST">
        <div class="row">
        <label for="product">Product Name</label>
     <select name="prodId" id="product">

    <?php 
    $sql = "SELECT  p.productId, p.product_Name FROM stk_inventory s INNER JOIN stk_products p ON s.productId = p.productId WHERE p.Status='Active'";
    ...
    if($query) {
      ...
      <div class="row"> 
        ...
        <input type="text" name="qty" id="quantity" requied>
       </div>




      <input type="submit" name="Send" value="Add To Outgoing">
      </form>
        </div>
    </div>
