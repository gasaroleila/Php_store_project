...
<table class="table table-bordered">
           <tr>
               ...
               <th scope="col">Update Inventory</th>
               <th scope="col">Delete from Inventory</th>
           </tr>

<?php include '../utils/db.php';
$sql = "SELECT i.quantity, p.product_Name, i.inventory_id, i.creator FROM stk_inventory i INNER JOIN stk_products p ON i.productId = p.productId";
...
<td><?=$row['quantity']?></td>
<td><?=$row['creator']?></td>
<td><a href="../Inventory/Invedit.php?InvId='<?php echo $row['inventory_id']?>'">update</a></td>
<td><a href="../Inventory/deleteFromInve.php?InvId='<?php echo $row['inventory_id']?>'">Delete</a></td>
</tr>
